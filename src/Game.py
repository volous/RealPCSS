...
class Game_handler:
    ...
    def __init__(self, game_surface):
        ...
        self.char1 = Character(3, player_id.PLAYER_ONE_ID, 1, 1, 249, 149, self.game_surface, self.level.walkable,
                               (255, 0, 0), pg.K_w, pg.K_s, pg.K_a, pg.K_d, pg.K_SPACE)

        self.char2 = Character(3, player_id.PLAYER_TWO_ID, 13, 1, 633, 149, self.game_surface, self.level.walkable,
        ...
        for c in self.characters:
            ...
            for b in self.bombs:
                if b.index_x == c.index_x and b.index_y == c.index_y:
                    can_place = False
            bomb = c.player_actions(can_place)
            if bomb is not None:
